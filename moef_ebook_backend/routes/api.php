...
Route::get('search-user-information/{searchParams}', [App\Http\Controllers\UserController::class, 'searchUserInformation']);
...
Route::delete('delete-meeting/{id}', [MeetingController::class, 'deleteMeeting']);
